...
SECRET_KEY = 'django-insecure-d@s=-9u4r)isq6!p%%=*-uh=usaeb-43#l7a%y-o&uu0gds39-'
...
STATICFILES_DIRS = [
    BASE_DIR / "static",  # For global static files (if any)
    # Django automatically checks app-specific static folders
]
